...
<body>
  <div id="login-screen">
<div class="login-box">
    <img src="https://admin.landapp.com.br/logo/svg/black.svg" alt="LandApp Logo Central">
...
<div class="sidebar">
    <a href="index.html" class="a-logo">
      <img alt="LandApp Logo" class="logo" src="https://admin.landapp.com.br/logo/svg/white.svg"/>
    </a>
    <h3 class="title">Dashboards - LandApp</h3>
